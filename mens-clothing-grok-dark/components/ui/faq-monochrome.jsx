...
function ensureStyles() {
  ...
  style.innerHTML = `
    ...
    .dark .faq-plus-icon.is-open { color: #FF6B35 !important; }
    .dark .faq-plus-icon.is-open path { stroke: #FF6B35 !important; }
            ...
            return (
              ...
              >
                ...
                <button
                  ...
                  className="relative flex w-full items-start gap-4 sm:gap-6 px-4 py-5 sm:px-7 sm:py-6 text-right transition-colors duration-300 focus-visible:outline focus-visible:outline-2 focus-visible:outline-offset-2 focus-visible:outline-[#FF6B35]/50"
                >
                  <span className={`relative flex h-10 w-10 sm:h-12 sm:w-12 shrink-0 items-center justify-center rounded-2xl border transition-all duration-500 ${
                      open
                        ? 'border-[#FF6B35]/60 bg-[#FF6B35]/15 dark:border-[#FF6B35]/70 dark:bg-[#FF6B35]/20'
                    ...
                    <span
                      className={`pointer-events-none absolute inset-0 rounded-2xl border opacity-30 ${
                        open ? 'border-[#FF6B35] animate-ping' : 'border-neutral-300 dark:border-white/40'
                      }`}
                    />
                    <svg
                      className={`faq-plus-icon relative h-4 w-4 sm:h-5 sm:w-5 transition-transform duration-500 ${
                        open ? 'is-open rotate-45 text-[#FF6B35]' : 'text-neutral-900 dark:text-white'
                      }`}
                      viewBox="0 0 24 24"
                      fill="none"
                      xmlns="http://www.w3.org/2000/svg"
                      aria-hidden
                      style={open ? { color: '#FF6B35' } : undefined}
                    >
